...
<!-- Provenance: copied from https://github.com/evanlenz/namespace-normalizer.
See also https://lenzconsulting.com/namespace-normalizer/.
No license is indicated for that file. -->
